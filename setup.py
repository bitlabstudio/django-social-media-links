"""
Python setup file for the social_media_links app.
...
social_media_links/__init__.py and re-run the above command.
...
import social_media_links as app
...
setup(
    ...
    url="https://github.com/bitmazk/django-social-media-links",
